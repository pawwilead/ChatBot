...
console.log("API_TOKEN:", process.env.API_TOKEN ? "Token Loaded" : "Token Missing");
console.log("PORT:", process.env.PORT);
console.log("BUSINESS_PHONE:", process.env.BUSINESS_PHONE);
...
app.post("/webhook", async (req, res) => {
  ...
  if (message?.type === "text") {
    ...
    await axios({
      method: "POST",
      url: `https://graph.facebook.com/${API_VERSION}.0/${BUSINESS_PHONE}/messages`,
      headers: {
        Authorization: `Bearer ${API_TOKEN}`,
      },
      data: {
